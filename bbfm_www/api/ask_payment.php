...
include_once "/var/www/bbfm_xfiles/bbfm_conf.php";
include_once "/var/www/bbfm_xfiles/bbfm_function.php";
...
if( $rate_age > 3600 ){
    return_error("We could not get a recent byteball change rate for the $currency currency.");
}
...
if( $amount_BB_asked > $max_amount_BB_asked ){
    ...
    return_error( "Byteball amount of payment cannot be greater than $max_amount_BB_asked Bytes" );
...
if( $amount_BB_asked < $min_amount_BB_asked ){
    ...
    return_error( "Byteball amount of payment cannot be lower than $min_amount_BB_asked Bytes" );
...
if( $amount_BB_asked < $fee_bbfm ){
    ...
    return_error( "The ByteBall payment amount ( $amount_BB_asked ) must be greater than the fees ( $fee_bbfm )" );
